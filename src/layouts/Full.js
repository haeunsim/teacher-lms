...
const FullLayout = ({ children }, state) => {
    ...
    const isCondensed = useMemo(() => leftSideBarType === layoutConstants.LEFT_SIDEBAR_TYPE_CONDENSED, [leftSideBarType]);
    const isLight = useMemo(() => leftSideBarTheme === layoutConstants.LEFT_SIDEBAR_THEME_LIGHT, [leftSideBarTheme]);
