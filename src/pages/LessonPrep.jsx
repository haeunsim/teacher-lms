...
const LessonPrep = () => {
  ...
  const data = [
    ...
    },
    {
      ...
      grade: "3-1",
      mainUnit: "1. 힘과 우리 생활",
      subUnit: "5. 우리 주 변 여러 장소에 대한 생각과 느낌을 나눠볼까요?",
      test: "",
      mute: "",
      link: "",
    },
      ...
      <section>
        ...
        <ChatContainer>
          ...
          <ContentsArea>
            ...
            <StepBar>
              <StepItem>
                <div className={`indicator ${completed ? "active" : ""}`}></div>
                채우기
              </StepItem>
              <StepItem>
                <div className={`indicator ${completed ? "active" : ""}`}></div>
